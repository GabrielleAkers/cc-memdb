...
local function mac(key, message)
    ...
    for i = 1, #message, 16 do
        ...
        -- Carry.
        local y0 = h0 + 3 * 2 ^ 69 - 3 * 2 ^ 69
        h0 = h0 - y0
        h1 = h1 + y0
        local y1 = h1 + 3 * 2 ^ 83 - 3 * 2 ^ 83
        h1 = h1 - y1
        h2 = h2 + y1
        local y2 = h2 + 3 * 2 ^ 101 - 3 * 2 ^ 101
        h2 = h2 - y2
        h3 = h3 + y2
        local y3 = h3 + 3 * 2 ^ 115 - 3 * 2 ^ 115
        h3 = h3 - y3
        h4 = h4 + y3
        local y4 = h4 + 3 * 2 ^ 133 - 3 * 2 ^ 133
        h4 = h4 - y4
        h5 = h5 + y4
        local y5 = h5 + 3 * 2 ^ 147 - 3 * 2 ^ 147
        h5 = h5 - y5
        h6 = h6 + y5
        local y6 = h6 + 3 * 2 ^ 163 - 3 * 2 ^ 163
        h6 = h6 - y6
        h7 = h7 + y6
        local y7 = h7 + 3 * 2 ^ 181 - 3 * 2 ^ 181
        h7 = h7 - y7
    ...
    local t0 = s0 + c0 + c1
    local u0 = t0 % 2 ^ 32
    local t1 = t0 - u0 + s1 * 2 ^ 32 + c2 + c3
    local u1 = t1 % 2 ^ 64
    local t2 = t1 - u1 + s2 * 2 ^ 64 + c4 + c5
    local u2 = t2 % 2 ^ 96
    local t3 = t2 - u2 + s3 * 2 ^ 96 + c6 + c7
    local u3 = t3 % 2 ^ 128
